...
static const struct pm8xxx_adc_map_pt zara_adcmap_btm_threshold[] = {
	{-200,	1671},
	{-190,	1663},
	{-180,	1654},
	{-170,	1646},
...
static struct pm8xxx_adc_map_table pm8xxx_adcmap_btm_table = {
	.table = zara_adcmap_btm_threshold,
	.size = ARRAY_SIZE(zara_adcmap_btm_threshold),
};
...
#if defined(CONFIG_MACH_ZARA) || defined(CONFIG_MACH_K2_CL)
